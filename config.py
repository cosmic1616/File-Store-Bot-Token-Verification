...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://saadsahebwale:TYjo9Qlosx6f9xNh@cluster0.ahtga.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "codeflix_bots")

#Shortner (token system) 

SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "adrinolinks.com")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "cee752e4913e44b7ba81a0038ce6bf32d068caaa")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID", "https://t.me/openshort_links/9") 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002140456005"))
